                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">
                                                ...
                                                @if($schedule->is_substitution)
                                                    <span class="text-xs text-gray-500">(Substituindo {{ $schedule->originalTeacher->name }})</span>
                                                @endif
                                            </div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                            <div class="flex justify-end space-x-2">
                                                <a href="{{ route('classes.schedules.edit', [$class, $schedule]) }}" class="text-indigo-600 hover:text-indigo-900" title="Editar">
                                                ...
                                                <form action="{{ route('classes.schedules.destroy', [$class, $schedule]) }}" method="POST" class="inline">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="text-red-600 hover:text-red-900" onclick="return confirm('Tem certeza que deseja excluir este horário?')" title="Excluir">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5">
                                                            <path d="M3 6h18"/>
